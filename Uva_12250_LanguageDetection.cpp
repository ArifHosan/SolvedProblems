...
int main() {
    ...
    while(cin>>s && s!="#") {
        CP();
        if(s=="HELLO") pf1("ENGLISH");
        else if(s=="HOLA") pf1("SPANISH");
        else if(s=="HALLO") pf1("GERMAN");
        else if(s=="BONJOUR") pf1("FRENCH");
        else if(s=="CIAO") pf1("ITALIAN");
        else if(s=="ZDRAVSTVUJTE") pf1("RUSSIAN");
        else pf1("UNKNOWN");
        pfl();
    }
	return 0;
